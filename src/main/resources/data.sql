...
INSERT INTO poker_session_manager.users (user_type, id, birthday_date, created, email, first_name, last_name, password, enabled, username) VALUES ('admin', 1, '2000-01-01', '2020-01-01 20:33:30', 'admin@gmail.com', 'Tomasz', 'Kapuśniak', '$2a$10$tZ4CMcR07gULGi2OJtzhMer/jZIwT2/FW7loNfHCVfZHaSWSVmy6e', 1,'user1' );
INSERT INTO poker_session_manager.users (user_type, id, birthday_date, created, email, first_name, last_name, password, enabled, username) VALUES ('player', 2,  '2000-07-01', '2022-11-18 20:35:14', 'user1@gmail.com', 'Paweł', 'Gracz', '$2a$10$tZ4CMcR07gULGi2OJtzhMer/jZIwT2/FW7loNfHCVfZHaSWSVmy6e', 1,  'user2');
INSERT INTO poker_session_manager.users (user_type, id, birthday_date, created, email, first_name, last_name, password, enabled, username) VALUES ('player', 3,  '2000-11-01', '2022-06-18 20:35:20', 'gamblerx@gmail.com', 'Arek', 'Winner', '$2a$10$tZ4CMcR07gULGi2OJtzhMer/jZIwT2/FW7loNfHCVfZHaSWSVmy6e', 1, 'user3');
...
INSERT INTO poker_session_manager.player_favourite_tournaments (player_id, tournament_id) VALUES (2, 2);
INSERT INTO poker_session_manager.player_favourite_tournaments (player_id, tournament_id) VALUES (2, 3);
...
INSERT INTO poker_session_manager.sessions (id, name, total_cost, tournament_count, player_id) VALUES (1, 'My first session', 155.0,2,2);
INSERT INTO poker_session_manager.sessions (id, name, total_cost, tournament_count, player_id) VALUES (2, 'My second session', 33.33,1,2);
